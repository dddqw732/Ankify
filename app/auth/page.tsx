...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 flex items-center justify-center p-4 py-12 md:py-4">
      {/* Background Effects */}
      <motion.div
        ...
        <div className="bg-gray-800/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-gray-700/50">
          ...
          <div className="flex mb-6 bg-gray-700/50 rounded-full p-1">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-full text-sm font-medium transition-all ${!isSignUp
